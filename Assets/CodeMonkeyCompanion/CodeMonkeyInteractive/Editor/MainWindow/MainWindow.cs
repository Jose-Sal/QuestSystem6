...
namespace CodeMonkey.CSharpCourse.Interactive {
    ...
    public class MainWindow : EditorWindow {
        ...
        public void CreateGUI() {
            ...
            Toggle objectiveBonus4 = root.Q<VisualElement>("bonusObjectivesContainer").Children().ToList()[3].Q<Toggle>();
            ...
            objectiveBonus4.value = CodeMonkeyInteractiveSO.GetObjectiveCheckboxState().bonusObjective4;
            ...
            objectiveBonus3.RegisterCallback<ChangeEvent<bool>>((changeEvent) => {
                GetObjectiveCheckboxState().bonusObjective3 = changeEvent.newValue;
                SetObjectiveCheckboxState(GetObjectiveCheckboxState());
            });
            objectiveBonus4.RegisterCallback<ChangeEvent<bool>>((changeEvent) => {
                GetObjectiveCheckboxState().bonusObjective4 = changeEvent.newValue;
                SetObjectiveCheckboxState(GetObjectiveCheckboxState());
            });
